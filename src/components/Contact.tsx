      ...
      <div className="container max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
          <div className="flex justify-center w-full">
            <AnimatedSection direction="left" threshold={0.2} className="h-full w-full max-w-md md:max-w-none">
          ...
          <div className="flex justify-center w-full">
            <AnimatedSection direction="right" threshold={0.2} delay={200} className="h-full w-full max-w-md md:max-w-none">
              <Card className="shadow-sm transition-all duration-300 hover:shadow-md h-full w-full">
                <CardHeader>
